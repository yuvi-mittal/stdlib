...
tape( 'if provided a negative integer for `x` and a valid `lambda`, the function returns `0`', opts, function test( t ) {
	var y = pmf( -20.0, 0.5 );
	t.equal( y, 0.0, 'returns expected value' );
...
tape( 'if provided a non-integer for `x` and a valid `lambda`, the function returns `0`', opts, function test( t ) {
	var y = pmf( -1.3, 0.5 );
	t.equal( y, 0.0, 'returns expected value' );
