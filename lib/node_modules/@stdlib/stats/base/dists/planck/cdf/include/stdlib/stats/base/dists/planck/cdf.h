...
#ifndef STDLIB_STATS_BASE_DISTS_PLANCK_CDF_H
#define STDLIB_STATS_BASE_DISTS_PLANCK_CDF_H
...
*
* @example
* double y = stdlib_base_dists_planck_cdf( 2.0, 0.5 );
* // returns ~0.7769
*/
...
#endif // !STDLIB_STATS_BASE_DISTS_PLANCK_CDF_H
