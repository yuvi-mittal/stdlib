...
tape( 'if provided a valid `lambda`, the function returns a function which returns `1` when provided `+infinity` for `x`', opts, function test( t ) {
	var cdf;
	var y;
...
tape( 'if provided a valid `lambda`, the function returns a function which returns `0` when provided a negative number for `x`', opts, function test( t ) {
	var cdf;
	var y;
