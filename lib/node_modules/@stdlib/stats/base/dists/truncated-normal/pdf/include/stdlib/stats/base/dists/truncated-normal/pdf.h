...
#ifndef STDLIB_STATS_BASE_DISTS_TRUNCATED_NORMAL_CDF_H
#define STDLIB_STATS_BASE_DISTS_TRUNCATED_NORMAL_CDF_H
...
#endif // !STDLIB_STATS_BASE_DISTS_TRUNCATED_NORMAL_PDF_H
