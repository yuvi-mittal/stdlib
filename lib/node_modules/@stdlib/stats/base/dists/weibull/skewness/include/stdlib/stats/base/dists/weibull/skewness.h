...
/**
* Evaluates the skewness of the Weibull distribution with shape parameter `k` and scale parameter `lambda`.
*
* @param k     shape parameter of the Weibull distribution
* @param lambda   scale parameter of the Weibull distribution
* @return    skewness of the Weibull distribution
*/
double stdlib_base_dists_weibull_skewness( double k, double lambda );
